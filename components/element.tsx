...
export function MemeCard({ meme }: MemeCardProps) {
    ...
    const elementsSmall = ["150px", "140px", "4px", meme.data.url];
    ...
    return meme.data.url.substring(meme.data.url.length - 4) == ".jpg"
        || meme.data.url.substring(meme.data.url.length - 4) == ".png"
        || meme.data.url.substring(meme.data.url.length - 5) == ".jpeg"
            ? (
                <div
                    key={meme.data.name}
                    style={{
